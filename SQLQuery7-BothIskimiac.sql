...
select 'Ok i have managed to find some data and based on that patient 287131, she should have a score of 13, yet in your data she has a score of 16. the same for ID 289282, ID 174129 should have a score of 14. It looks like the score is adding 3 for some reason' [BothCauseType], * 
from #temp
where HT_PAT_ID in ('287131','289282','174129')
...
--Ok i have managed to find some data and based on that patient 287131, she should have a score of 13, yet in your data she has a score of 16. the same for ID 289282, ID 174129 should have a score of 14. It looks like the score is adding 3 for some reason
--287131
--289282
--174129
...
--Key Characteristics at Clinic
SELECT DISTINCT
'KEY CHARACTERISTICS' as 'KEY CHARACTERISTICS'
,
  t1.VISIT_CLINIC,
  t1.HT_PAT_ID,
  t1.VISIT_SIGNOFF_DATE,
  ...
  --(  t1.[EQ3L_AnxietyDepLevel]+  t1.[EQ3L_activities_score]+ t1.[EQ3L_anxiety_score]+ t1.[EQ3L_mobility_score]+  t1.[EQ3L_pain_score]+  t1.[EQ3L_self_care_score]) as [EQ3L Score],
   ...
   t1.[EQ3L_pain_score],
   t1.[EQ3L_self_care_score],
   (  t1.[EQ3L_activities_score]+ t1.[EQ3L_anxiety_score]+ t1.[EQ3L_mobility_score]+  t1.[EQ3L_pain_score]+  t1.[EQ3L_self_care_score]) as [EQ3L Score],
...
--where t1.HT_PAT_ID in ('287131','289282','174129')
;
