...
left join HF_Patient_Drugs PD 
	on 
	A.HT_PAT_ID = PD.HT_PAT_ID 
	and 
	A.VISIT_ID = PD.VISIT_ID  and  PH.HT_PAT_ID = PD.HT_PAT_ID and PH.VISIT_ID = PD.VISIT_ID and PD.MGMT_PH_NAME = 'Digoxin' and PD.MGMT_PH_TYPE = 'hoc-other-hf-drugs-drugs'

	left join [dbo].[HF_Patient_Follow_up] fu on A.HT_PAT_ID = fu.HT_PAT_ID and a.VISIT_ID = fu.VISIT_ID
